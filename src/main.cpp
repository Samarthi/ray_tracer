...
int main(){
	...
	//diffuse sphere
	Vec4 sp1_org = {0.0, -5.0, 20.0, 0.0}; float radius_sp1 = 5.0f; Vec3 sp1_color = {10, 0, 100}; 
	Material mat1 = {sp1_color, 0.16, 0.6, 0.3, 0};
	sp[0] = {sp1_org, radius_sp1, mat1};
	
	//specular sphere
	Vec4 sp2_org = {0.0, 15.0, 20.0, 0.0}; float radius_sp2 = 9.0f; Vec3 sp2_color = {45, 200, 7};
	Material mat2 = {sp2_color, 0.18, 0.8, 0.9, 100};
	...
	lights[0] = {{10.0f, 20.0f, 10.0f, 0.0f}, {255, 255, 255}};  	
